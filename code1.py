...
# Sağ panel (menü için)
right_panel = tk.Frame(main_container, bg='#1E1E1E', width=200)
...
# Menü öğeleri
menu_items = []
menu_texts = ["Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 6", "Item 7", "Item 8"]
current_selection = 0

for i, text in enumerate(menu_texts):
    btn = tk.Label(right_panel, text=text, font=('Arial', 12), 
            ...
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                if detect_thumbs_up(landmarks):
                    ...
                    if detect_swipe_left(position_history):
                        ...
                        # Yukarı kaydırma - menüde yukarı git
                        current_selection = max(0, current_selection - 1)
                        highlight_item(current_selection)
                    elif detect_swipe_down(position_history):
                        gesture_detected = "Swipe Down"
                        # Aşağı kaydırma - menüde aşağı git
